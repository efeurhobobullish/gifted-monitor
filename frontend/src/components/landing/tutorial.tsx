    ...
    <section id="tutorial" className="py-20 relative main">
      ...
      <ScrollAnimation className="text-center mb-16 max-w-2xl mx-auto">
        ...
        <p className="text-muted text-sm max-w-2xl mx-auto">
          A quick walkthrough for signup, monitors, and alert channels — swap
          in your own screencast when ready.
        </p>
      </ScrollAnimation>
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          <div className="w-full h-[500px] rounded-xl overflow-hidden border border-line bg-background">
            <iframe
              ...
              title="Gifted Monitor walkthrough"
              frameBorder="0"
          ...
          <p className="text-center text-xs text-muted">
            Replace this embed with a product tour of monitors and alerts.
          </p>
        </div>
      </ScrollAnimation>
    </section>
