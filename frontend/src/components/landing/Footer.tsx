...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="border-t border-line bg-secondary text-main">
      <div className="main py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted text-sm max-w-sm leading-relaxed">
              ...
              when something goes down or comes back. Signup with email OTP;
              choose WhatsApp, Telegram, and/or email for monitor alerts.
            </p>
        ...
        <div className="pt-6 border-t border-line flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted text-sm text-center md:text-left">
            © {currentYear} Gifted Monitor. Built by{" "}
            <a
              href="https://empiretech.net.ng"
              target="_blank"
              rel="noopener noreferrer"
