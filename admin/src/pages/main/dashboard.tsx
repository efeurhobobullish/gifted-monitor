  ...
  return (
    <HomeLayout>
      <section className="main py-10 space-y-12">
        {/* ================= ADMIN QUICK LINKS ================= */}
        <div className="glass border border-line rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted text-sm mt-1">
              Backend API: <code className="bg-secondary px-1.5 py-0.5 rounded text-xs">{BACKEND_BASE_URL || "Not set"}</code>
            </p>
          </div>
          <button
            onClick={() => navigate("/dashboard/settings/api")}
            className="btn-secondary h-10 px-5 rounded-full flex items-center gap-2 shrink-0"
          >
            <Server size={16} />
            API Settings
          </button>
